...
#================================================
# این تابع PDF را binary می‌خواند و مثلاً می‌دهد:
# 7a8f86c5f36b61c4c8a96e4f...
# نکته مهم این است که ID بر اساس محتوای فایل است، نه اسمش.
#================================================
...
#اين تابع بررسي ميكند كه آيا اين داكيومنت قبلا پردازش شده است يا خير
def document_exists(
    document_id: str,
) -> bool:
    """
